...
# How to Download and Prepare "Cosmo Buddy" Game Files

Cosmo Buddy is an indie game available on itch.io. This tutorial will guide you through downloading the game file, renaming it, and moving it to the appropriate folder.

## Step 1: Download the Game File

1. Visit the Cosmo Buddy game page on itch.io: [Cosmo Buddy](https://easy82.itch.io/cosmo-buddy).
...
2. Find the downloaded `.pck` file. It might be named something like `cosmo_buddy_vX.XX.pck`.
...
1. After moving the file, you can now launch Cosmo Buddy.
2. The game should recognize the `game.pck` file in the `gamedata` folder and load the necessary resources.

Congratulations! You've successfully downloaded and prepared Cosmo Buddy for gameplay.
