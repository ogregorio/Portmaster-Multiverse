...
# How to Download and Prepare "Kobold Kastilla" Game Files

Kobold Kastilla is an indie game available on itch.io. This tutorial will guide you through downloading the game file, renaming it, and moving it to the appropriate folder.

## Step 1: Download the Game File

1. Visit the Kobold Kastilla game page on itch.io: [Kobold Kastilla](https://michaelwave1997.itch.io/kobold-kastilla).
...
2. Find the downloaded `.pck` file. It might be named something like `kobold_kastilla_vX.XX.pck`.
...
1. After moving the file, you can now launch Kobold Kastilla.
2. The game should recognize the `game.pck` file in the `gamedata` folder and load the necessary resources.

Congratulations! You've successfully downloaded and prepared Kobold Kastilla for gameplay.
